...
static iomux_v3_cfg_t mx6qd_seco_q7_pads[] = {
        /* SD2 */
	MX6Q_PAD_SD2_CLK__USDHC2_CLK,	 //        - for SD signal to logic
	MX6Q_PAD_SD2_CMD__GPIO_1_11,	 //        - for SD signal to logic
	MX6Q_PAD_SD2_DAT0__USDHC2_DAT0,  //   	- for SD signal to logic
	MX6Q_PAD_SD2_DAT1__USDHC2_DAT1,  //   	- for SD signal to logic
	MX6Q_PAD_SD2_DAT2__USDHC2_DAT2,  //   	- for SD signal to logic
	MX6Q_PAD_SD2_DAT3__USDHC2_DAT3,  //   	- for SD signal to logic
	...
	/* UART1 */
	MX6Q_PAD_SD3_DAT6__UART1_RXD,		/*OPTIONAL DUART_RXD*/ /*ATTENTION configurable as MX6Q_PAD_SD3_DAT6__USDHC3_DAT6_50MHZ*/  //   
	MX6Q_PAD_SD3_DAT7__UART1_TXD,		/*OPTIONAL DUART_TXD*/ /*ATTENTION configurable as MX6Q_PAD_SD3_DAT7__USDHC3_DAT7_50MHZ*/  //   
	...
	MX6Q_PAD_NANDF_CS2__GPIO_6_15,		/*SD1_CD*/   //     - for SD on board
	//MX6Q_PAD_GPIO_19__GPIO_4_5, 		/*SD1_WP*/   //     - for SD on board
	MX6Q_PAD_CSI0_DATA_EN__GPIO_5_20, 				//	SD1_WP   - for SD on board
#ifdef CONFIG_MMC1_8bit
	MX6Q_PAD_NANDF_D0__USDHC1_DAT4,		/*SD1_DAT4*/  //     - for SD on board
	MX6Q_PAD_NANDF_D1__USDHC1_DAT5,		/*SD1_DAT5*/  //     - for SD on board
	MX6Q_PAD_NANDF_D2__USDHC1_DAT6,		/*SD1_DAT6*/  //     - for SD on board
	MX6Q_PAD_NANDF_D3__USDHC1_DAT7,		/*SD1_DAT7*/  //     - for SD on board
#endif
	...
	MX6Q_PAD_SD3_DAT6__USDHC3_DAT6_50MHZ,		/*eMMC_DAT6*/ /*ATTENTION Primary configuration as MX6Q_PAD_SD3_DAT6__UART1_RXD*/	//   
	MX6Q_PAD_SD3_DAT7__USDHC3_DAT7_50MHZ,		/*eMMC_DAT7*/ /*ATTENTION Primary configuration as MX6Q_PAD_SD3_DAT7__UART1_TXD*/	//   
#endif
	...
	MX6Q_PAD_NANDF_D5__GPIO_2_5,			//    - gpio generic
	MX6Q_PAD_SD4_DAT5__GPIO_2_13,			//    - gpio generic
	MX6Q_PAD_SD4_DAT6__GPIO_2_14,			//    - gpio generic
	...
	MX6Q_PAD_GPIO_8__GPIO_1_8,			//    - gpio generic
        ...
        /* CPLD CLOCK  */
	MX6Q_PAD_GPIO_0__CCM_CLKO,		/* CPLD_GPIO_0_CLKO -> CPLD Clock??? */  //   
	...
	MX6Q_PAD_GPIO_16__I2C3_SDA,		/*I2C3_SDA*/ //    - for I2C3S
