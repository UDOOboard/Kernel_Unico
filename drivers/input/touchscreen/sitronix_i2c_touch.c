...
#define SITRONIX_TOUCH_RESOLUTION_X 1024 /* max of X value in display area */
#define SITRONIX_TOUCH_RESOLUTION_Y 768 /* max of Y value in display area */
...
static int __init touch_invert_x(char *str)
{
        printk("Sitronix invert X axis\n");
        if (*str)
                return 0;
        sitronix_invert_x = 1;
...
__setup("sitronix_invert_x", touch_invert_x);

static int sitronix_invert_y = 0;   /* Optionally invert Y axis value */
static int __init touch_invert_y(char *str)
{
        printk("Sitronix invert Y axis\n");
        if (*str)
                return 0;
        sitronix_invert_y = 1;
...
__setup("sitronix_invert_y", touch_invert_y);
