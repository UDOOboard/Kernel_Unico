...
#define TSC2004_MEASURE_TEMP0		(0x0 << 4)
#define TSC2004_MEASURE_AUX		(0x2 << 4)
#define TSC2004_MEASURE_TEMP1		(0x4 << 4)
#define TSC2004_ACTIVATE_XN		(0x8 << 4)
#define TSC2004_ACTIVATE_YN		(0x9 << 4)
#define TSC2004_ACTIVATE_YP_XN		(0xa << 4)
#define TSC2004_SETUP			(0xb << 4)
#define TSC2004_MEASURE_X		(0xc << 4)
#define TSC2004_MEASURE_Y		(0xd << 4)
#define TSC2004_MEASURE_Z1		(0xe << 4)
#define TSC2004_MEASURE_Z2		(0xf << 4)

#define TSC2004_POWER_OFF_IRQ_EN	(0x0 << 2)
#define TSC2004_ADC_ON_IRQ_DIS0		(0x1 << 2)
#define TSC2004_ADC_OFF_IRQ_EN		(0x2 << 2)
#define TSC2004_ADC_ON_IRQ_DIS1		(0x3 << 2)

#define TSC2004_12BIT			(0x0 << 1)
#define TSC2004_8BIT			(0x1 << 1)

#define	MAX_12BIT			((1 << 12) - 1)

#define ADC_ON_12BIT	(TSC2004_12BIT | TSC2004_ADC_ON_IRQ_DIS0)

#define READ_Y		(ADC_ON_12BIT | TSC2004_MEASURE_Y)
#define READ_Z1		(ADC_ON_12BIT | TSC2004_MEASURE_Z1)
#define READ_Z2		(ADC_ON_12BIT | TSC2004_MEASURE_Z2)
#define READ_X		(ADC_ON_12BIT | TSC2004_MEASURE_X)
#define PWRDOWN		(TSC2004_12BIT | TSC2004_POWER_OFF_IRQ_EN)
...
#define TSC2004_CFR0_PENMODE		 0x8000 // 0x8x000
#define TSC2004_CFR0_STS			 0x0000
#define TSC2004_CFR0_RESOLUTION12	 0x2000
#define TSC2004_CFR0_CLOCK_1MHZ		 0x1000
#define TSC2004_CFR0_STABTIME_1MS	 0x0300
#define TSC2004_CFR0_PRECHARGE_276US 0x0040
#define TSC2004_CFR0_SENCE_TIME_20   0x0000
#define TSC2004_CFR0_DTW			 0x0002
#define TSC2004_CFR0_LONGER_SAMPLING 0x0000   
#define TSC2004_CFR0_INITVALUE		(TSC2004_CFR0_PENMODE    	  | \
									 TSC2004_CFR0_STS      	      | \
									 TSC2004_CFR0_RESOLUTION12    | \
					 				 TSC2004_CFR0_CLOCK_1MHZ      | \
									 TSC2004_CFR0_STABTIME_1MS    | \
									 TSC2004_CFR0_PRECHARGE_276US | \
									 TSC2004_CFR0_SENCE_TIME_20   | \
					 				 TSC2004_CFR0_DTW             | \
									 TSC2004_CFR0_LONGER_SAMPLING)

/* bits common to both read and write of configuration register 0 */
#define	TSC2004_CFR0_RW_MASK		0x3fff

/* configuration register 1 */
#define TSC2004_CFR1_BATCHDELAY_4MS	 0x0004 //4
#define TSC2004_CFR1_INITVALUE		TSC2004_CFR1_BATCHDELAY_4MS

/* configuration register 2 */
#define TSC2004_CFR2_PINT            0x8000 // 0x8000 aggiunto settaggio del pin penirq
#define TSC2004_CFR2_MEDIUM_15       0x3000	// M1 M0
#define TSC2004_CFR2_AVG_7           0x0800	// W1 W0
#define TSC2004_CFR2_ZONE_DETECT	 0x0000	// TZ1 TZ0 AZ1 AZ0
#define TSC2004_CFR2_MAVE_X          0x0010 
#define TSC2004_CFR2_MAVE_Y          0x0008
#define TSC2004_CFR2_MAVE_Z          0x0004
#define TSC2004_CFR2_MAVE_AUX        0x0000
#define TSC2004_CFR2_MAVE_TEMP       0x0000
#define TSC2004_CFR2_INITVALUE      (TSC2004_CFR2_PINT			| \
									 TSC2004_CFR2_MEDIUM_15 	| \
                                     TSC2004_CFR2_AVG_7			| \
									 TSC2004_CFR2_ZONE_DETECT   | \
									 TSC2004_CFR2_MAVE_X        | \
                                     TSC2004_CFR2_MAVE_Y        | \
                                     TSC2004_CFR2_MAVE_Z        | \
                                     TSC2004_CFR2_MAVE_AUX		| \
									 TSC2004_CFR2_MAVE_TEMP)
				   ...
				   const struct i2c_device_id *id)
{
	...
	ts->poll_delay        = pdata->poll_delay ? : TS_POLL_DELAY;
    ts->poll_period       = pdata->poll_period ? : TS_POLL_PERIOD;
	ts->get_pendown_state = pdata->get_pendown_state;
	ts->clear_penirq      = pdata->clear_penirq;

	/*if (tsc2004_xfer(ts, PWRDOWN) < 0) {
	/	err = -ENODEV;
		goto err_no_dev;
	}*/
	...
	input_set_abs_params(input_dev, ABS_PRESSURE, 0, MAX_12BIT, pdata->fuzzz, 0);

	if (pdata->init_platform_hw)
		pdata->init_platform_hw();

	err = request_irq(ts->irq, tsc2004_irq, 0, client->dev.driver->name, ts);
	if (err < 0) {
